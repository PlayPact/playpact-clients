...
namespace Org.OpenAPITools.Model
{
    ...
    /// MyServerListDto
    /// </summary>
    [DataContract(Name = "MyServerListDto")]
    public partial class MyServerListDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MyServerListDto" /> class.
        /// </summary>
        ...
        public MyServerListDto(Guid playPactServerId = default(Guid), string name = default(string), string description = default(string), string ipAddress = default(string), string port = default(string), string tag = default(string), string logoUri = default(string))
        {
