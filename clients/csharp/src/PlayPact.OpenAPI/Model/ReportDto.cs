...
namespace PlayPact.OpenAPI.Model
{
    ...
    public partial class ReportDto : IValidatableObject
    {
        ...
        public ReportDto(Guid playPactReportId = default(Guid), string accusation = default(string), ReportStatus? reportStatus = default(ReportStatus?), List<RuleListDto> rules = default(List<RuleListDto>), ServerListDto server = default(ServerListDto))
        {
