...
namespace PlayPact.OpenAPI.Model
{
    ...
    /// ServerListDto
    /// </summary>
    [DataContract(Name = "ServerListDto")]
    public partial class ServerListDto : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerListDto" /> class.
        /// </summary>
        ...
        public ServerListDto(Guid playPactServerId = default(Guid), string name = default(string), string description = default(string), string ipAddress = default(string), string port = default(string), string tag = default(string), string logoUri = default(string))
        {
