...
> testAddingPactPoints(newAmount, reason)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer newAmount = 56; // Integer | 
    String reason = "reason_example"; // String | 
    try {
      apiInstance.testAddingPactPoints(newAmount, reason);
    } catch (ApiException e) {
      System.err.println("Exception when calling TestApi#testAddingPactPoints");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TestApi#testGettingPactPoints");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TestApi#testGettingPactPointsHistory");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
