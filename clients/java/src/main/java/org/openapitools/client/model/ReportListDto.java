...
public class ReportListDto {
  ...
  public ReportListDto playPactReportId(UUID playPactReportId) {
  ...
  **/
  ...
  public ReportListDto accusation(String accusation) {
  ...
  **/
  ...
  public ReportListDto serverName(String serverName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReportListDto reportListDto = (ReportListDto) o;
    return Objects.equals(this.playPactReportId, reportListDto.playPactReportId) &&
        Objects.equals(this.accusation, reportListDto.accusation) &&
        Objects.equals(this.serverName, reportListDto.serverName);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ReportListDto
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportListDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportListDto is not found in the empty JSON string", ReportListDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportListDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportListDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportListDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportListDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportListDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportListDto.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportListDto>() {
           @Override
           public void write(JsonWriter out, ReportListDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportListDto read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReportListDto given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReportListDto
  * @throws IOException if the JSON string is invalid with respect to ReportListDto
  */
  public static ReportListDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportListDto.class);
  }

 /**
  * Convert an instance of ReportListDto to an JSON string
  *
  * @return JSON string
  */
