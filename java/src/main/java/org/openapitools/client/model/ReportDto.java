...
public class ReportDto {
  ...
  public ReportDto playPactReportId(UUID playPactReportId) {
  ...
  **/
  ...
  public ReportDto accusation(String accusation) {
  ...
  **/
  ...
  public ReportDto reportStatus(ReportStatus reportStatus) {
  ...
  **/
  ...
  public ReportDto rules(List<RuleListDto> rules) {
    this.rules = rules;
    return this;
  }

  public ReportDto addRulesItem(RuleListDto rulesItem) {
    if (this.rules == null) {
  ...
  **/
  ...
  public ReportDto server(ServerListDto server) {
    this.server = server;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public ServerListDto getServer() {
    return server;
  }

  public void setServer(ServerListDto server) {
    this.server = server;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.playPactReportId, reportDto.playPactReportId) &&
        Objects.equals(this.accusation, reportDto.accusation) &&
        Objects.equals(this.reportStatus, reportDto.reportStatus) &&
        Objects.equals(this.rules, reportDto.rules) &&
        Objects.equals(this.server, reportDto.server);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(playPactReportId, accusation, reportStatus, rules, server);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("server") != null && !jsonObj.get("server").isJsonNull()) {
        ServerListDto.validateJsonElement(jsonObj.get("server"));
      }
  }
