...
public class Example {
  public static void main(String[] args) {
    ...
    CreateRuleDto createRuleDto = new CreateRuleDto(); // CreateRuleDto | 
    try {
      apiInstance.createRule(createRuleDto);
    } catch (ApiException e) {
      System.err.println("Exception when calling RuleApi#createRule");
...
<a id="getRule"></a>
# **getRule**
> RuleDto getRule(playPactRuleId)
...
public class Example {
  public static void main(String[] args) {
    ...
    RuleApi apiInstance = new RuleApi(defaultClient);
    UUID playPactRuleId = UUID.randomUUID(); // UUID | 
    try {
      RuleDto result = apiInstance.getRule(playPactRuleId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RuleApi#getRule");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling RuleApi#getRules");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    RuleApi apiInstance = new RuleApi(defaultClient);
    RuleDto ruleDto = new RuleDto(); // RuleDto | 
    try {
